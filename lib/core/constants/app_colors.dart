...
class AppColors {
  // Primary Colors
  static const Color primary = Color.fromARGB(255, 32, 211, 190);
  static const Color primaryLight = Color.fromARGB(255, 35, 191, 222);
  static const Color primaryDark = Color.fromARGB(236, 76, 206, 229);
